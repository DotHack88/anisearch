  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[70vh] px-4">
      <div className="w-full max-w-md bg-surface p-8 rounded-2xl border border-surface-light shadow-2xl relative overflow-hidden">
        ...
        <div className="absolute -top-32 -left-32 w-64 h-64 bg-accent/20 rounded-full blur-3xl pointer-events-none"></div>
        ...
        <h2 className="font-display text-4xl text-text mb-2 tracking-wide">Registrati</h2>
        <p className="text-text-dim text-sm mb-8">Crea un account per iniziare il tuo viaggio</p>
